...
There are three statistics modules offered by postgraduate programmes at UCL Psychology and Language Sciences (PALS). These are pitched at a fundamental, intermediate, and advanced level. Each postgraduate programme suggests a default module. Depending on your experience and ability, it may be possible for you to switch to a module pitched at a *higher* level than this default. Such a switch can be requested by you or the programme director. It will always require approval by the programme director. The ultimate reason for switching is to enhance your learning opportunity and to acquire new transferable skills. The module you take will also be reflected on your degree transcript. As such, taking a more advanced module could be beneficial to later opportunities. But the main thing to consider is whether a module is right for you at the time you are undertaking your postgraduate degree. There are always opportunities for later learning. In all modules, we aim to provide the best learning experience for our students. In the end, there should be no penalty for choosing the module that is right for you.
...
The module's materials are available here: [https://mspeekenbrink.github.io/sdam-book/](https://mspeekenbrink.github.io/sdam-book/) and [https://mspeekenbrink.github.io/sdam-r-companion/](https://mspeekenbrink.github.io/sdam-r-companion/)
